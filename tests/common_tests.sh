...
df -B1 | PYTHONPATH=`pwd` $1 poline/poline.py -s "'{:10.10}\t{:10.10}\t{:10.10}\t{:10.10}\t{:5.5}\t{}{}\t{:10.10}'.format(i[0],bytesize(i[1],f=True),bytesize(i[2],f=True),bytesize(i[3],f=True),i[4],'▓'*int(10*int(i[2])/int(i[1])+0.5) if i[1].isdigit() else ' '*5, '░'*(10-int(10*int(i[2])/int(i[1])+0.5)) if i[1].isdigit() else ' '*5,i[5]) for i in _"